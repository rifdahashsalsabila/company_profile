        ...
        <div class="card border-0 shadow-sm rounded-4" style="background: #f9f9fb;">
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center mb-3">
                    ...
                    <a href="/admin/user/create" class="btn btn-primary px-3 py-2 shadow-sm"
                ...
                <table class="table align-middle table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><span class="badge bg-secondary-subtle text-dark px-3 py-2 rounded-pill"
                                    style="background:#e6e6ea;">{{ ucfirst($item->role) }}</span></td>
